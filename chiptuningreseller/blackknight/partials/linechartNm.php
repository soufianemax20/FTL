<?php if (in_array('premium', Ctr_Api_Connector::connection_valid()['subscriptions']) || in_array('medium', Ctr_Api_Connector::connection_valid()['subscriptions'])) {
    ...
    foreach ($increaseNm as $increase) {
        ...
        if (is_numeric($stage_1['data']['nm_tuning'])) {
            ...
            $legendNmStage_1 = '<div style="display:flex; flex-direction: row;margin-right:12px;"><span style="margin-right:5px; height:12px;width:12px;background:#262626;border-radius: 100%;margin: auto 5px auto 0px;"></span><span>Stage 1</span></div>';
            };
            if($stage_2 !== null){
            $lineDataNmStage_2 .= round($stage_2['data']['nm_tuning'] * $increase / 100) . $addComma;
            $legendNmStage_2 = '<div style="display:flex; flex-direction: row;margin-right:12px;"><span style="margin-right:5px; height:12px;width:12px;background:#61b8ff;border-radius: 100%;margin: auto 5px auto 0px;"></span><span>Stage 2</span></div>';
            };
            if($stage_3 !== null){
            $lineDataNmStage_3 .= round($stage_3['data']['nm_tuning'] * $increase / 100) . $addComma;
            $legendNmStage_3 = '<div style="display:flex; flex-direction: row;margin-right:12px;"><span style="margin-right:5px; height:12px;width:12px;background:#0079d9;border-radius: 100%;margin: auto 5px auto 0px;"></span><span>Stage 3</span></div>';
            };
        }
        $i++;
    }
        ...
        <div class="ctr-w-full px-2">
            <div class="ctr-rounded-lg ctr-shadow-sm mb-4">
                <div class="ctr-rounded-lg ctr-bg-white ctr-relative ctr-overflow-hidden">
                    ...
                    <span class="ctr-text-[#262626] ctr-text-[28px] ctr-font-semibold ctr-ml-3">Torque</span>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (dynoChart !== null && typeof(dynoChart) !== 'undefined') {
                ...
                gradientNmOri.addColorStop(0.3, '#787878');
                gradientNmOri.addColorStop(0.6, '#bdbdbd');
                var gradientNmStage_1 = dynoChart.createLinearGradient(0, 0, 0, 400);
                gradientNmStage_1.addColorStop(0, '#262626');
                gradientNmStage_1.addColorStop(1, '#474747');
                var gradientNmStage_2 = dynoChart.createLinearGradient(0, 0, 0, 400);
                gradientNmStage_2.addColorStop(0, '#61b8ff');
                gradientNmStage_2.addColorStop(1, '#3da8ff');
                var gradientNmStage_3 = dynoChart.createLinearGradient(0, 0, 0, 400);
                gradientNmStage_3.addColorStop(0, '#0079d9');
                gradientNmStage_3.addColorStop(1, '#3da8ff');
