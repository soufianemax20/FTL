<?php if (in_array('premium', Ctr_Api_Connector::connection_valid()['subscriptions']) || in_array('medium', Ctr_Api_Connector::connection_valid()['subscriptions'])) {
    ...
    foreach ($increaseHp as $increase) {
        ...
        if (is_numeric($stage_1['data']['hp_tuning'])) {
            ...
            $legendHpStage_1 = '<div style="display:flex; flex-direction: row;margin-right:12px;"><span style="margin-right:5px; height:12px;width:12px;background:#5046e4;border-radius: 100%;margin: auto 5px auto 0px;"></span><span>Stage 1</span></div>';
            };
            if($stage_2 !== null){
            ...
            <span style="margin-right:5px; height:12px;width:12px;background:#291dcd;border-radius: 100%;margin: auto 5px auto 0px;"></span><span>Stage 2</span>
            </div>';
            };
            if($stage_3 !== null){
            ...
            <span style="margin-right:5px; height:12px;width:12px;background:#180f95;border-radius: 100%;margin: auto 5px auto 0px;"></span><span>Stage 3</span>
            </div>';
        };
        }
        $i++;
            ...
            <div class="ctr-rounded-lg ctr-shadow-sm mb-4">
                <div class="ctr-rounded-lg ctr-bg-white ctr-relative ctr-overflow-hidden">
                    <div class="ctr-bottom-0 ctr-inset-x-0">
                        <span style="color:#001B4E; font-size:24px; font-weight: 600;margin-left:12px;">Power</span>
                        <div style="display:flex; flex-direction: row;margin-left:12px;margin-bottom:12px;">
                            <div style="display:flex; flex-direction: row;margin-right:12px;">
                                <span style="margin-right:5px; height:12px;width:12px;background:#8982ed;border-radius: 100%;margin: auto 5px auto 0px;"></span><span>Ori</span>
                            </div>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (dynoChart !== null && typeof(dynoChart) !== 'undefined') {
                ...
                gradientHpOri.addColorStop(0.3, '#8982ed'); //top
                gradientHpOri.addColorStop(0.6, '#b1acf6'); //bottom
                var gradientHpStage1 = dynoChart.createLinearGradient(0, 0, 0, 400);
                gradientHpStage1.addColorStop(0, '#5046e4');
                gradientHpStage1.addColorStop(1, '#c9e6ed');
                var gradientHpStage2 = dynoChart.createLinearGradient(0, 0, 0, 400);
                gradientHpStage2.addColorStop(0, '#291dcd');
                gradientHpStage2.addColorStop(1, '#c9e6ed');
                var gradientHpStage3 = dynoChart.createLinearGradient(0, 0, 0, 400);
                gradientHpStage3.addColorStop(0, '#180f95');
                gradientHpStage3.addColorStop(1, '#c9e6ed');
