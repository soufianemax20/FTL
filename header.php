...
<script>
    (function() {
        ...
        // Failsafe: Force hide after 1.5 seconds if something hangs
...
<header id="masthead"
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <!-- MOBILE MENU TOGGLE (Hidden, replaced by Bottom Nav) -->
            <!-- Use hidden class to completely remove top menu button if Bottom Nav is active -->
            <!-- However, keeping it as fallback or for tablets if 'md' breakpoint isn't met -->
            <button class="md:hidden hidden flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-[#D7F207]/50 hover:bg-[#D7F207]/10 text-white transition-all duration-300 group z-50 relative"
    ...
    <!-- BOTTOM NAVIGATION BAR (Mobile App Mode) -->
    <div class="md:hidden fixed bottom-0 left-0 w-full z-[1000] bg-[#0D0D0D]/95 backdrop-blur-lg border-t border-white/10 pb-safe pt-2 px-2 shadow-[0_-5px_20px_rgba(0,0,0,0.5)]">
        <div class="flex justify-around items-center h-16">
            <!-- Home -->
            <a href="<?php echo home_url('/'); ?>" class="flex flex-col items-center justify-center w-full h-full text-gray-400 hover:text-[#D7F207] transition-colors group">
            ...
            <!-- Search/Selector -->
            <a href="<?php echo function_exists('ctr_print_full_start_url') ? ctr_print_full_start_url(false) : home_url('/chip-tuning/'); ?>" class="flex flex-col items-center justify-center w-full h-full text-gray-400 hover:text-[#D7F207] transition-colors group">
                <svg class="w-6 h-6 mb-1 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Brands (Center/Featured) -->
            <div class="relative -top-5">
                <a href="<?php echo home_url('/brands-catalog/'); ?>" class="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-[#D7F207] to-[#F2EA79] text-black shadow-[0_0_15px_rgba(215,242,7,0.5)] border-4 border-[#0D0D0D] transform transition-transform active:scale-95">
            ...
            <!-- Fileservice -->
            <a href="<?php echo home_url('/fileservice/'); ?>" class="flex flex-col items-center justify-center w-full h-full text-gray-400 hover:text-[#D7F207] transition-colors group">
                <svg class="w-6 h-6 mb-1 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Menu (More) -->
            <button @click="mobileMenuOpen = !mobileMenuOpen" class="flex flex-col items-center justify-center w-full h-full text-gray-400 hover:text-[#D7F207] transition-colors group">
                <svg class="w-6 h-6 mb-1 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" :class="{'text-[#D7F207]': mobileMenuOpen}">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                </svg>
